...
//   	chrome.cookies.set(link);
 $(document).ready(function () {
  window.setTimeout(main,10000);
	...
	function main(){
  	var URL_Concept = "https://localhost:8080/api/summary/https%3A%2F%2Farstechnica.com%2Fscience%2F2017%2F07%2Fa-brief-history-of-quantum-alternatives%2F" ;
    $.ajax({
            type: 'GET',
            url: URL_Concept,
            dataType: 'json',
  ...
  function processJSON(Json){
    ...
    document.getElementById("sum1").innerHTML = summary;
    ...
    document.getElementById("links1").innerHTML = Links[0].displayUrl;
    document.getElementById("href1").href = Links[0].url;
    document.getElementById("description1").innerHTML = Links[0].description;
    document.getElementById("extra1").innerHTML = Links[0].name;
  }
